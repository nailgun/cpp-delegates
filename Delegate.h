...
{
public:
    virtual Return call(Arg1 arg1, Arg2 arg2, Arg3 arg3) const = 0;
...
{
public:
    virtual Return call(Arg1 arg1, Arg2 arg2) const = 0;
...
{
public:
    virtual Return call(Arg1 arg1) const = 0;
